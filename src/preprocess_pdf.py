    ...
    for i in range(len(bookmark_list)):
        try:
            dic = {
                ...
                "end_page": reader.get_destination_page_number(bookmark_list[i + 1])
                + 1,
            }
        except:
            dic = {
...
def split_book_chapters(bookmarks, pdf_reader):
    ...
    for i in bookmarks:
        ...
        chapters.append(
            {
                "content": concat_pages,
                "meta": {
                    "book_title": "DAMA-DMBOK Data Management Book of Knowledge",
                    "chapter": i["bookmark_title"],
